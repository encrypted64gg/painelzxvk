...
def show_banner(text='ZXVK',font='ansi_shadow'):A=pyfiglet.figlet_format(text,font=font);print(Fore.GREEN+center_text('Executado com sucesso.'));print(Fore.CYAN+center_text('Sistema de segurança ativado.')+_C);print(Fore.CYAN+center_text(A)+_C);show_system_info()
